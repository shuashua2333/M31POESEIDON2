...
use p3_field::{Field, PrimeField32, PrimeField};
use rand::thread_rng;
...
fn main() {
    ...
    let p_minus_1 = Mersenne31::from_canonical_unchecked(0x7FFFFFFE); // 2^31 - 2
    ...
    for _ in 0..10 {
        ...
        let a_val: u32 = rand::random::<u32>() % 2147483647;
        let b_val: u32 = rand::random::<u32>() % 2147483647;
        
        let a = Mersenne31::from_canonical_unchecked(a_val);
        let b = Mersenne31::from_canonical_unchecked(b_val);
...
fn print_case(a: Mersenne31, b: Mersenne31) {
    ...
    // logical [30:0] a, b, exp_sum, exp_mul;
    println!(
    ...
    // Also print a SV-friendly assignment line
    println!(
